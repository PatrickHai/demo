...
function create(treeData) {
    ...
    var showTip = function(d) {
       if(d.value){
            d3.select('.d3-force-tip').attr('class', 'd3-force-tip block');
            return '<div>'+d.value+'</div>';
       }else{
            d3.select('.d3-force-tip').attr('class', 'd3-force-tip hidden');
            return '<div>'+d.value+'</div>';
       }
    };
    var tip = d3.tip()
    ...
    function click(d) {
        ...
        if(d.type == 'silk' && d.children == null && d._children == null ){
           console.log('silk clicked !!! ')
           $.ajax({
               url:'/api/silkTree/',
               data:{
                   id: d.id
        ...
        }else if(d.type == 'drug' && d.children == null && d._children == null ){
